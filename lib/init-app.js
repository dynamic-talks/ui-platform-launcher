...
import { uiRouterFactory } from './lib/router/ui-router.factory';
import { createServerIocContainer } from 'platform-core/lib/ui-application/server.ioc-container';
...
export function initApp({ rootPath, serverIoCFactory }) {
